class Api::V1::Accounts::Contacts::CallsController < Api::V1::Accounts::BaseController
  ...
  rescue_from Voice::OutboundCallBuilder::IdempotencyConflict, with: :render_idempotency_conflict
  rescue_from Voice::OutboundCallBuilder::OperationInProgress, with: :render_operation_in_progress
