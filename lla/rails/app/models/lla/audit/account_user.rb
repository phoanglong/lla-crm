...
# Ghi vết kiểm toán cho AccountUser — năng lực do LLA phát triển (Wave B2).
#
...
module Lla::Audit::AccountUser
  extend ActiveSupport::Concern

  included do
    audited associated_with: :audited_account, on: %i[create update]
  end
