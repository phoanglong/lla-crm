...
# Ghi vết kiểm toán cho Conversation — năng lực do LLA phát triển (Wave B2).
#
...
module Lla::Audit::Conversation
  extend ActiveSupport::Concern

  included do
    audited associated_with: :audited_account, on: %i[destroy]
  end
