...
RSpec.describe Twilio::VoiceWebhookSetupService do
  ...
  it 'deletes the newly created TwiML App when number configuration fails' do
    application_url = "#{twilio_base_url}/Applications/AP123.json"
    stub_request(:post, phone_number_url).to_return(status: 500, body: '{}')
